...
#ifndef MYCOBOT_INTERFACES__MSG__DETAIL__COOK_STATE__TYPE_SUPPORT_H_
#define MYCOBOT_INTERFACES__MSG__DETAIL__COOK_STATE__TYPE_SUPPORT_H_
...
#endif  // MYCOBOT_INTERFACES__MSG__DETAIL__COOK_STATE__TYPE_SUPPORT_H_

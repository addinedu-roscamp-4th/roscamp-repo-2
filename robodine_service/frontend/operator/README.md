...
- **AI 챗봇 대화 기능**: 사용자와의 대화 및 로봇과의 상호작용
- **고객 및 테이블 관리**: 고객 정보 및 테이블 상태 모니터링
...
### AI 챗봇 대화
![AI 챗봇 대화](/docs/images/operator_chatbot.png)
### 영상 스트리밍
